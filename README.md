...
| **Agents** (31) | `architect`, `code-reviewer`, `security-auditor`, `karpathy-reviewer`, `spec-tracer`, `tdd-test-writer`, `tdd-implementer`, `mobile-dev`, `cloud-architect`, `deployment-engineer` (base), `azure-deployment-engineer`, `vercel-deployment-engineer`, `railway-deployment-engineer`, `render-deployment-engineer`, `digitalocean-deployment-engineer`, `incident-responder`, `architect-review`, `claude-md-guardian`, ... |
