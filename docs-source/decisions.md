...
Per-feature OQ + SubQ resolutions in newest-first order. Each card shows the resolution headline only — see the source `docs/analysis-v*.md` workflow file for the full reasoning.

[Dashboard →](dashboard.html) &nbsp; · &nbsp; [Feature history →](feature-history.html)

<svg viewBox="0 0 800 50" data-snippet-mount="timeline-scrubber" aria-label="pipelinekit decisions timeline">
  <line x1="20" y1="25" x2="780" y2="25" stroke="currentColor" stroke-width="2"/>
</svg>

## Cards

<details class="decisions-card" data-feature="13/13">
  <summary>13/13 · feat/dashboard-and-decisions-log · 2026-05-23</summary>
  <ul class="decisions-list">
  <li class="oq-resolution"><strong>OQ-1:</strong> 12-section budget for dashboard (larger than spec&#x27;s 8 proposal)</li>
  <li class="oq-resolution"><strong>OQ-2:</strong> decisions log ordered newest-first (most actionable for current contributors</li>
  <li class="oq-resolution"><strong>OQ-3:</strong> index</li>
  <li class="oq-resolution"><strong>OQ-4:</strong> (c) HYBRID extractor</li>
  <li class="oq-resolution"><strong>OQ-5:</strong> dashboard</li>
  <li class="subq-resolution"><strong>SubQ-A:</strong> workflow_extractor</li>
  <li class="subq-resolution"><strong>SubQ-B:</strong> At /post-merge Step 12 hygiene block, when features_pruner</li>
  <li class="subq-resolution"><strong>SubQ-C:</strong> Two paths considered:</li>
  <li class="subq-resolution"><strong>SubQ-D:</strong> Should decisions</li>
  <li class="subq-resolution"><strong>SubQ-E:</strong> test_workflow_extractor_no_leak</li>
  <li class="subq-resolution"><strong>SubQ-F:</strong> documentation/index</li>
  <li class="subq-resolution"><strong>SubQ-G:</strong> Spec proposed 8; OQ-1 resolved to 12</li>
</ul>
  <p class="decisions-source"><em>Source:</em> docs/analysis-v91.md</p>
</details>
...
<details class="decisions-card" data-feature="?/?">
  <summary>?/? · docs/skill-authoring-standard · 2026-05-17</summary>
  <p><em>decisions not recovered (analysis file missing from workflow dir)</em></p>
  <p class="decisions-source"><em>Source:</em> docs/analysis-v13.md</p>
</details>
...
<details class="decisions-card" data-feature="?/?">
  <summary>?/? · feat/charter-auto-extract · 2026-05-18</summary>
  <p><em>decisions not recovered (analysis file missing from workflow dir)</em></p>
  <p class="decisions-source"><em>Source:</em> docs/analysis-v26.md</p>
</details>
...
<details class="decisions-card" data-feature="?/?">
  <summary>?/? · feat/deployment-provider-digitalocean · 2026-05-19</summary>
  <p><em>decisions not recovered (analysis file missing from workflow dir)</em></p>
  <p class="decisions-source"><em>Source:</em> docs/analysis-v59.md</p>
</details>
