...
- **`documentation/`** — Application documentation (API refs, user guides, architecture docs). This is where YOU write.
- **`docs/`** — Reserved for AI workflow files (progress.md, plan.md, prompts.md). NEVER write application documentation here.

Always output to `documentation/` unless the project has an existing different convention.
