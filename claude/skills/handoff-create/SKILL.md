...
This command complements the project's progress tracking system:

**Long-term tracking** (committed to docs/):
- `docs/progress.md` — Current plan file, current task, status table
- `docs/plan.md` / `docs/plan-vN.md` — Phase and task breakdowns
- `docs/prompts.md` — Task prompts with model, effort, agent specs

**Session-specific handoff** (created by this command):
- `whats-next.md` — Detailed session handoff for context-full pauses

**Usage Pattern**:
- Use `docs/progress.md` for ongoing task tracking across sessions
- Use `/handoff-create` when context is full or pausing complex work
- Reference both when resuming: `docs/progress.md` first, then `whats-next.md`
